...
const index = require('./shared/udeno.75b7308b.cjs');
...
const toPath$2 = urlOrPath => urlOrPath instanceof URL ? node_url.fileURLToPath(urlOrPath) : urlOrPath;
...
const require$$1$1 = /*@__PURE__*/index.getAugmentedNamespace(core$1);
...
const require$$7 = /*@__PURE__*/index.getAugmentedNamespace(typos$2);
...
const require$$1 = /*@__PURE__*/index.getAugmentedNamespace(warning_messages$1);
...
async function readPackage({cwd, normalize = true} = {}) {
	...
	const json = parseJson_1(await fs$1.promises.readFile(filePath, 'utf8'));
...
function showHelp() {
  ...
  metas.forEach((meta) => {
    sections.push(
      colorette.magenta("> ") + colorette.cyan(meta.usage) + " or " + colorette.cyan(meta.alias)
    );
    sections.push("   " + meta.description);
  });
  sections.unshift(`${colorette.bold(colorette.blue("args help"))}`);
  index.log.log(sections.join("\n\n") + "\n");
}
